  ...
  <div id="cu_login_container" class="cu_nav_menu">
    ...
    <?php if (is_user_logged_in()): ?>
      <div id="cu_logged_in" class="cu_dropdown_menu">
        ...
        <p class="cu_display_name boxfit">
          <?php echo $current_user->display_name; ?>
        </p>
        <a href="<?php echo get_home_url(1, 'profile', (FORCE_SSL_ADMIN) ? 'https' : 'http'); ?>">Edit Profile</a> |
        <a href="<?php echo wp_logout_url('http://' . $_SERVER['HTTP_HOST'] . $_SERVER['PHP_SELF']); ?>"
          id="cu_logout">Logout</a>
      </div>

    <?php else: ?>
      <div id="cu_login_form" class="cu_dropdown_menu">
        <form
          action="<?php echo (FORCE_SSL_LOGIN === true) ? home_url(null, 'https') : home_url(null, 'http'); ?>/wp-login.php"
          method="post">
    ...
    <ul class="cu_dropdown_menu">
      ...
      <li>
        <a class="cu_nav_button" href="https://exchange.chapman.edu/">
          <svg class="email svg-icon" viewbox="0 0 512 512">
            <path
              d="M480,64H32C14.4,64,0,78.4,0,96v320c0,17.6,14.399,32,32,32h448c17.6,0,32-14.4,32-32V96C512,78.4,497.6,64,480,64zM448,128v23L256,264.143L64,151v-23H448z M64,384V206.714l192,113.144l192-113.144V384H64z">
            </path>
          </svg>
          Staff &amp; Faculty Email
        </a>
          ...
          <ul>
            ...
            <li>
              <a href="https://blogs.chapman.edu/business/"
                title="Blog for Argyros College of Business &amp; Economics">Argyros College of Business &amp;
                Economics</a>
            </li>
            <li>
